...
The original llms.txt proposal was published in September 2024, when the idea that language models would routinely read websites was still speculative. Since then the community has taken to the proposal far more than we expected. Thousands of sites now publish an llms.txt file, documentation platforms generate one automatically, and coding agents fetch them as a matter of course. Agents went from prediction to daily reality, and that shift is what this revision reflects.
