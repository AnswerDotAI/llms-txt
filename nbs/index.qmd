...
- [vite-plugin-llms](https://github.com/yourusername/vite-plugin-llms) - Vite plugin that serves markdown files alongside your routes following the llms.txt specification
