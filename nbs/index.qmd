...
- [`agentmarkup`](https://github.com/agentmarkup/agentmarkup) - Build-time llms.txt generation, JSON-LD injection, markdown mirrors, AI crawler robots.txt management, and validation for Vite and Astro websites
