...
- [Drupal llms.txt module](https://www.drupal.org/project/llmstxt) - Drupal module for adding and managing the contents of llms.txt file through a simple admin interface.
