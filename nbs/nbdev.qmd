...
Another technique that can speed you along the way is tapping an LLM for help. You can pass it content from multiple sources and ask it to help you synthetize it into a cohesive description. This works well, because summarizing or translating content from one format to another is something LLMs can do very well.
